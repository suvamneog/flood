  ...
  return (
    <div className="relative h-[420px] w-full overflow-hidden rounded-2xl border border-border shadow-sm dark:border-border-dark sm:h-[520px] lg:h-[560px]">
      ...
      <button
        ...
        className={`absolute right-3 top-3 z-[500] inline-flex items-center gap-1.5 rounded-xl border px-3 py-2 text-xs font-bold shadow-md backdrop-blur transition active:scale-95 ${
          heatOn
            ? 'border-primary-300 bg-primary-600 text-white'
            : 'border-border bg-white/90 text-slate-700 dark:border-border-dark dark:bg-slate-900/90 dark:text-slate-200'
        }`}
      >
      ...
      {/* Severity legend */}
      <div className="absolute bottom-3 left-3 z-[500] flex flex-wrap gap-2 rounded-xl border border-border bg-white/90 px-3 py-2 text-[11px] font-semibold shadow-md backdrop-blur dark:border-border-dark dark:bg-slate-900/90">
